  ...
  const renderTone =
    renderStatus === "failed"
      ...
      : renderStatus === "ready"
        ? "info"
        : "info";
  const renderStatusLabel = resolveRenderStatusLabel(t, renderStatus);
  const renderStatusHint = resolveRenderStatusHint(t, renderStatus);
...
function resolveRenderStatusLabel(
  t: Translator,
  renderStatus?: DigitalHumanSession["renderStatus"],
) {
  switch (renderStatus) {
    case "queued":
      return t(msg`排队中`);
...
function resolveRenderStatusHint(
  t: Translator,
  renderStatus?: DigitalHumanSession["renderStatus"],
) {
  switch (renderStatus) {
