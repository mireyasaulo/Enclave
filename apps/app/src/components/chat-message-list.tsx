...
export function ChatMessageList({
  ...
  const shareContactSummary = async (
    ...
    const summary = buildContactAttachmentSummary(t, attachment, profileUrl);
  ...
  const shareNoteSummary = async (
    ...
    const summary = buildNoteAttachmentSummary(t, attachment);
...
function parseSharedHistorySummaryMessage(t: Translator, text: string) {
  ...
  // i18n-ignore-next-line: protocol-format wire regex (matches messages built by zh-CN sender; kept as marker, not UI copy)
    ...
    <div className="fixed inset-0 z-50 bg-[rgba(5,10,20,0.88)] backdrop-blur-md">
      ...
      <div className="relative flex h-full flex-col">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 px-4 pb-[calc(env(safe-area-inset-bottom,0px)+1rem)] pt-2">
          <ViewerActionButton
            label={
              nativeMobileShareSupported ? t(msg`系统分享`) : t(msg`复制位置`)
            }
    ...
    <div className="fixed inset-0 z-50 bg-[rgba(5,10,20,0.88)] backdrop-blur-md">
      ...
      <div className="relative flex h-full flex-col">
            ...
            <div className="min-h-0 flex-1 overflow-auto px-5 py-5 text-white">
              ...
              <div className="mt-5 grid grid-cols-3 gap-2.5">
                ...
                <NoteViewerMetric
                  label={t(msg`内容`)}
                  value={
                    attachment.excerpt?.trim() ? t(msg`有摘要`) : t(msg`待补充`)
                  }
                />
              </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 px-4 pb-[calc(env(safe-area-inset-bottom,0px)+1rem)] pt-2">
          <ViewerActionButton
            label={
              nativeMobileShareSupported ? t(msg`系统分享`) : t(msg`复制摘要`)
            }
            onClick={onShareOrCopy}
          >
            {nativeMobileShareSupported ? (
