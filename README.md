...
> 💻 想从源码本地跑（`pnpm dev` 一键拉起 api+app+admin）、调 Android 壳、或了解端口/重启脚本？看 [DEVELOPMENT.md](DEVELOPMENT.md)。
...
扫码加我个人微信，备注「隐界」，一起聊聊这件事：

<p align="center">
  <img src="docs/assets/wechat-personal-qr.png" alt="作者个人微信二维码" width="240" />
</p>
...
- [DEVELOPMENT.md](DEVELOPMENT.md) —— 本地开发：pnpm dev 全套、单服务启停、端口、Android 联调、环境变量
